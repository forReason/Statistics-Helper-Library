...
{
    /// <summary>
    /// Provides a lightweight and fast method to compute a simple exponential moving average for decimal values.
    ...
    internal class SimpleExponentialAverage_Decimal
    {
        ...
        public SimpleExponentialAverage_Decimal(
            uint maxDataLength,
            decimal divergenceCorrection = 0.2929687m,
            string backupPath = "")
        {
        ...
        private void RestoreBackup()
        {
            ...
            try
            {
                ...
                if (lines.Length >= 2 &&
                    decimal.TryParse(lines[0], NumberStyles.Number, CultureInfo.InvariantCulture, out var value) &&
