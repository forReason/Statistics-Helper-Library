...
namespace QuickStatistics.Net.Average_NS
{
    ...
    /// <summary>
    /// Provides a lightweight and fast method to compute a simple exponential moving average for generic numeric types.
    /// This class is particularly useful for time series data where quick calculations are needed, and the data size is large.
    /// </summary>
    /// <remarks>Has an internal conversion to double for larger numbers; consider using <see cref="SimpleExponentialAverage_Decimal"/> for decimals.</remarks>
    public class SimpleExponentialAverage<T> where T : INumber<T>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SimpleExponentialAverage{T}"/> class with specified settings.
        /// </summary>
        ...
        public SimpleExponentialAverage(
            uint maxDataLength,
        ...
        {
            _CurrentDataLength++;
            Value += (Convert.ToDouble(input) - Value) / _CurrentDataLength;
