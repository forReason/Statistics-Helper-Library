...
namespace Statistics_unit_tests
{
    public class Average
    {
        ...
        {
            // positive tests
            double testResult = Statistics.Average.VolumeBasedAverage(value1: 0.1, volume1: 2, value2: 0.01, volume2: 0.1);
            if (testResult != 0.09571428571428571)
            {
                throw new System.Exception($"result was: {testResult} should be: 0.09571428571428571");
            }
            testResult = Statistics.Average.VolumeBasedAverage(value1: 0.1, volume1: 2, value2: 0.9, volume2: 0.1);
            ...
            testResult = Statistics.Average.VolumeBasedAverage(value2: 0.1, volume2: 2, value1: 0.01, volume1: 0.1);
            if (testResult != 0.09571428571428571)
            {
                throw new System.Exception($"result was: {testResult} should be: 0.09571428571428571");
            }
            testResult = Statistics.Average.VolumeBasedAverage(value2: 0.1, volume2: 2, value1: 0.9, volume1: 0.1);
            if (testResult != 0.1380952380952381)
            {
                throw new System.Exception($"result was: {testResult} should be:  0.1380952380952381");
            }
        ...
        public void BasicVolumeAverage_EqualValues()
        {
            ...
            { // equal volume and value
                double testResult = Statistics.Average.VolumeBasedAverage(value1: i, volume1: Math.Abs(i), value2: i, volume2: Math.Abs(i));
                if (testResult != i)
                {
            ...
            { // equal value
                double testResult = Statistics.Average.VolumeBasedAverage(value1: i, volume1: rng.NextDouble(), value2: i, volume2: rng.NextDouble());
                if (testResult != i)
                {
                    throw new System.Exception($"result was: {testResult} should be: {i}");
                }
        ...
        public void BasicVolumeAverage_PositiveNegativeValues()
        {
            ...
            {
                testResult = Statistics.Average.VolumeBasedAverage(value1: i, volume1: i, value2: -i, volume2: i);
                if (testResult != 0)
                {
            ...
            // manual test cases
            testResult = Statistics.Average.VolumeBasedAverage(value1: 0.1, volume1: 2, value2: -0.01, volume2: 0.1);
            if (testResult != 0.094761904761904769)
            {
                throw new System.Exception($"result was: {testResult} should be:  0.094761904761904769");
            }
            testResult = Statistics.Average.VolumeBasedAverage(value1: 0.1, volume1: 2, value2: -0.9, volume2: 0.3);
            ...
            testResult = Statistics.Average.VolumeBasedAverage(value2: 0.1, volume2: 2, value1: -0.9, volume1: 0.3);
            if (testResult != -0.030434782608695657)
            {
                throw new System.Exception($"result was: {testResult} should be:  -0.030434782608695657");
            }
        ...
        {
            // edge cases
            double testResult = Statistics.Average.VolumeBasedAverage(value2: double.MaxValue, volume2: 5, value1: double.MinValue, volume1: 10);
